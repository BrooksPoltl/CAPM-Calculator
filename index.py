...
output = 40
change_index = 0
risk_free_data = requests.get('https://www.quandl.com/api/v3/datasets/FRED/DGS10.json?api_key=7B5AzQw-ywWDnn2faGUM&collapse=monthly')
...
print(adjusted_risk_free_prices)
print(len(adjusted_risk_free_prices))
